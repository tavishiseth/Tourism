...
public class Vehicle extends javax.swing.JFrame {
    ...
    public void fetch() {
        try {
            ...
            rs = pst.executeQuery();
            Vtable.setModel(buildTableModel(rs));
        }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("VEHICLE DASHBOARD");
        ...
        headerLayout.setHorizontalGroup(
                headerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, headerLayout.createSequentialGroup()
                                ...
                                .addComponent(Back)
                                .addGap(73, 73, 73)
                                .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 274,
        ...
        Vtable.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "Vehicle ID", "Vehicle Name", "Vehicle Type", "Capacity", "Register Number"
                }));
                ...
                sidepaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(sidepaneLayout.createSequentialGroup()
                                ...
                                .addGroup(sidepaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(sidepaneLayout.createSequentialGroup()
                                                .addComponent(scrolvehicletable, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        839, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addContainerGap(11, Short.MAX_VALUE))
                                        .addGroup(sidepaneLayout.createSequentialGroup()
                                                .addGroup(sidepaneLayout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                        .addGroup(sidepaneLayout.createSequentialGroup()
                                                                .addGap(32, 32, 32)
                                                                .addGroup(sidepaneLayout.createParallelGroup(
                        ...
                        .addGroup(sidepaneLayout.createSequentialGroup()
                                ...
                                .addGroup(sidepaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(sidepaneLayout
                                                ...
                                                .addComponent(Vname, javax.swing.GroupLayout.PREFERRED_SIZE, 28,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(jLabel2))
                                        .addComponent(Addbtn, javax.swing.GroupLayout.PREFERRED_SIZE, 36,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(28, 28, 28)
                                .addGroup(sidepaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(sidepaneLayout.createSequentialGroup()
                                                .addGroup(sidepaneLayout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(Vtype, javax.swing.GroupLayout.PREFERRED_SIZE, 28,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(Modbtn, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        ...
                                        .addGroup(sidepaneLayout.createSequentialGroup()
                                                ...
                                                .addGroup(sidepaneLayout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(Regno, javax.swing.GroupLayout.PREFERRED_SIZE, 31,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(jLabel4))))
                                .addGap(81, 81, 81)
                                .addComponent(scrolvehicletable, javax.swing.GroupLayout.PREFERRED_SIZE, 92,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap()));
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(bg, javax.swing.GroupLayout.PREFERRED_SIZE, 869,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ModbtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ModbtnActionPerformed
        ...
        String modsql = "UPDATE VEHICLE SET VNAME=?,CAP=?,VTYPE=?,REGNO=? WHERE VID =" + cell;

        try {
            pst = conn.prepareStatement(modsql);

            pst.setString(1, Vname.getText());
            pst.setString(2, Vtype.getText());
            pst.setString(3, cap.getText());
    ...
    private void AddbtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_AddbtnActionPerformed
        ...
        String query = "insert into vehicle (vid,vname,cap,vtype,regno)"
                + " values ( ?,?, ?, ?, ?)";
    ...
    private void VtableMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_VtableMouseClicked
        ...
        Vtype.setText(model.getValueAt(selectedRowIndex, 2).toString());
        cap.setText(model.getValueAt(selectedRowIndex, 3).toString());
